...
public class HeartBeatCopy : BeatReceiver 
{
    ...
    public override void OnBeat()
    {
		...
		GameObject clone;
		clone = Instantiate(mHeartPulse, transform.position, Quaternion.identity) as GameObject;
		clone.GetComponent<Pulse>().mMaxRadius = 7f;
    }
}
